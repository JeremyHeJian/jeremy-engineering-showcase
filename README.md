...
**Why this repo exists:** my main products' repositories stay private (one of them runs live payments), but the engineering decisions are the interesting part — so the two modules here are extracted, sanitized versions of the real code, with write-ups of the problems they solve.
